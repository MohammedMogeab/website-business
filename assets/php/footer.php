...
<footer class="footer">
    <div class="container grid-list">
      ...
      <div class="footer-brand">
        ...
        <p class="footer-text">
          &copy; 2022 company programming . <br> All rights reserved.
        </p>
      ...
      <ul class="footer-list">
        ...
        <li>
          <address class="footer-text">
            Taiz St. 14 . Taiz City, Yemen
          </address>
        </li>

        <li>
          <a href="mailto:info@email.com" class="footer-link">mohammedmogeab@gmail.com</a>
        </li>
